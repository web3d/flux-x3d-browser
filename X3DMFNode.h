 ...
 *
 * File: X3DMFNode.h
 * Description: Declaration of the CX3DMFNode
 *
...
// X3DMFNode.h : Declaration of the CX3DMFNode

#ifndef __X3DMFNODE_H_
#define __X3DMFNODE_H_
...
/////////////////////////////////////////////////////////////////////////////
// CX3DMFNode
class ATL_NO_VTABLE CX3DMFNode : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CX3DMFNode, &CLSID_CoX3DMFNode>,
	public IDispatchImpl<X3DMFNode, &IID_X3DMFNode, &LIBID_ANIMALib>,
	X3DFieldBase
{
public:
	CX3DMFNode()
...
DECLARE_REGISTRY_RESOURCEID(IDR_X3DMFNODE)

DECLARE_PROTECT_FINAL_CONSTRUCT()

BEGIN_COM_MAP(CX3DMFNode)
	COM_INTERFACE_ENTRY(X3DMFNode)
	...
	COM_INTERFACE_ENTRY2(IDispatch, X3DMFNode)
END_COM_MAP()

protected :
	NodeArray		*m_mfnodevalue;
...
public:
	...
	STDMETHOD(get1ValueV)(/*[in]*/ int index, /*[out]*/ VARIANT *value);
	STDMETHOD(get1Value)(/*[in]*/ int index, /*[out]*/ X3DNode **value);
	// STDMETHOD(setValue)(/*[in]*/ int cnt, /*[in, out, size_is(cnt)]*/ X3DNode **value);
	STDMETHOD(setValue)(/*[in]*/ X3DNodeArray *value);
	STDMETHOD(set1Value)(/*[in]*/ int index, /*[in]*/ X3DNode *value);
	STDMETHOD(getValue)(/*[out, retval]*/ X3DNodeArray **value);
