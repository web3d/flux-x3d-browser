 ...
 * Flux
 *
 * File: anmpositioninterpolator.h
...
#ifndef _anmpositioninterpolator_h
#define _anmpositioninterpolator_h

#include "anmnode.h"
#include "anminterpolator.h"

class CAnmPositionInterpolator : public CAnmNode
{
protected:
...
public:
	...
	CAnmPositionInterpolator();
	virtual ~CAnmPositionInterpolator();
...
#endif // _anmpositioninterpolator_h
