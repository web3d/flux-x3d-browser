 ...
 * Flux
 *
 * File: anmsplinepositioninterpolator.h
...
#ifndef _anmsplinepositioninterpolator_h
#define _anmsplinepositioninterpolator_h

#include "anmnode.h"
#include "anmsplineinterpolator.h"

class CAnmSplinePositionInterpolator : public CAnmNode
{
protected:

	CAnmSplineInterpolator<Point3>		m_interp;

public:

	// constructor/destructor
	CAnmSplinePositionInterpolator();
	virtual ~CAnmSplinePositionInterpolator();
	...
	virtual void SetKeyVelocity(Point3Array *pKeyVelocity);
	virtual Point3Array *GetKeyVelocity() { return m_interp.GetKeyVelocity(); }
	virtual void GetKeyVelocity(Point3Array **pKeyVelocity) { m_interp.GetKeyVelocity(pKeyVelocity); }
	...
	DECLARE_NODECLASS(CAnmSplinePositionInterpolator);
...
#endif // _anmsplinepositioninterpolator_h
