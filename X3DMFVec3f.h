 ...
 *
 * File: X3DMFVec3f.h
 * Description: Declaration of the CX3DMFVec3f
 *
...
// X3DMFVec3f.h : Declaration of the CX3DMFVec3f

#ifndef __X3DMFVEC3F_H_
#define __X3DMFVEC3F_H_
...
/////////////////////////////////////////////////////////////////////////////
// CX3DMFVec3f
class ATL_NO_VTABLE CX3DMFVec3f : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CX3DMFVec3f, &CLSID_CoX3DMFVec3f>,
	public IDispatchImpl<X3DMFVec3f, &IID_X3DMFVec3f, &LIBID_ANIMALib>,
	X3DFieldBase
{
public:
	CX3DMFVec3f()
...
DECLARE_REGISTRY_RESOURCEID(IDR_X3DMFVEC3F)

DECLARE_PROTECT_FINAL_CONSTRUCT()

BEGIN_COM_MAP(CX3DMFVec3f)
	COM_INTERFACE_ENTRY(X3DMFVec3f)
...
public:
	...
	STDMETHOD(set1Value)(/*[in]*/ int index, /*[in]*/ X3DSFVec3f *value);
	STDMETHOD(getValue)(/*[in]*/ int cnt, /*[in, out, size_is(cnt)]*/ float *value);
	STDMETHOD(get1Value)(/*[in]*/ int index, /*[out]*/ X3DSFVec3f **value);
