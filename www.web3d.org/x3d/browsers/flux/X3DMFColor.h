 ...
 *
 * File: X3DMFColor.h
 * Description: Declaration of the CX3DMFColor
 *
...
// X3DMFColor.h : Declaration of the CX3DMFColor

#ifndef __X3DMFCOLOR_H_
#define __X3DMFCOLOR_H_
...
/////////////////////////////////////////////////////////////////////////////
// CX3DMFColor
class ATL_NO_VTABLE CX3DMFColor : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CX3DMFColor, &CLSID_CoX3DMFColor>,
	public IDispatchImpl<X3DMFColor, &IID_X3DMFColor, &LIBID_ANIMALib>,
	X3DFieldBase
{
public:
	CX3DMFColor()
...
DECLARE_REGISTRY_RESOURCEID(IDR_X3DMFCOLOR)

DECLARE_PROTECT_FINAL_CONSTRUCT()

BEGIN_COM_MAP(CX3DMFColor)
	COM_INTERFACE_ENTRY(X3DMFColor)
	...
	COM_INTERFACE_ENTRY2(IDispatch, X3DMFColor)
END_COM_MAP()

protected :
	ColorArray		*m_mfcolorvalue;
...
public:
	...
	STDMETHOD(set1Value)(/*[in]*/ int index, /*[in]*/ X3DSFColor *value);
	STDMETHOD(get1Value)(/*[in]*/ int index, /*[out]*/ X3DSFColor **value);
