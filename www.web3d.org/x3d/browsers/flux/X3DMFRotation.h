 ...
 * Flux
 *
 * File: X3DMFRotation.h
 * Description: Declaration of the CX3DMFRotation
 *
...
// X3DMFRotation.h : Declaration of the CX3DMFRotation

#ifndef __X3DMFROTATION_H_
#define __X3DMFROTATION_H_
...
/////////////////////////////////////////////////////////////////////////////
// CX3DMFRotation
class ATL_NO_VTABLE CX3DMFRotation : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CX3DMFRotation, &CLSID_CoX3DMFRotation>,
	public IDispatchImpl<X3DMFRotation, &IID_X3DMFRotation, &LIBID_ANIMALib>,
	X3DFieldBase
{
public:
	CX3DMFRotation()
...
DECLARE_REGISTRY_RESOURCEID(IDR_X3DMFROTATION)

DECLARE_PROTECT_FINAL_CONSTRUCT()

BEGIN_COM_MAP(CX3DMFRotation)
	COM_INTERFACE_ENTRY(X3DMFRotation)
...
protected :
	...
	RotationArray		*m_mfrotationvalue;
...
public:
	...
	STDMETHOD(set1Value)(/*[in]*/ int index, /*[in]*/ X3DSFRotation *value);
	STDMETHOD(getValue)(/*[in]*/ int cnt, /*[in, out, size_is(cnt)]*/ float *value);
	STDMETHOD(get1Value)(/*[in]*/ int index, /*[out]*/ X3DSFRotation **value);
