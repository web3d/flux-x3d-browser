...
#ifndef _anmocxplugin_h
#define _anmocxplugin_h

#include "anmplugin.h"

class CAnmOCXPlugin : public CAnmPlugin
{
protected :

	class CAnimaCtrl			*m_ctl;

public:


	CAnmOCXPlugin(class CAnimaCtrl *pCtrl);
	virtual ~CAnmOCXPlugin();
