...
static char sFluxMIMEDescription[ANMMAXSTRBUF];

static char *sFluxMIMETypes =
...
static char *sFluxDefaultMethod = ".getBrowser";

static char *sFluxDescription = "Flux Player - The Universal 3D Media Player. For more information, please visit <a href=\"http://www.mediamachines.com\">www.mediamachines.com</a>";

char *
NPP_GetMIMEDescription(void)
{
	sprintf(sFluxMIMEDescription, "%s:%s:%s", sFluxMIMETypes, sFluxDefaultMethod, sFluxDescription);

	return sFluxMIMEDescription;
}
...
{   
  ...
  CPlugin * pPlugin = new CPlugin(instance, mode, argc, argn, argv);
...
NPError NPP_Destroy (NPP instance, NPSavedData** save)
{
  ...
  if(pPlugin != NULL) {
    pPlugin->shut();
		// krv:
		//Crash here on the second destroy
		//
    delete pPlugin;
  }
  return rv;
