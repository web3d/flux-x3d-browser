...
#ifndef _anmd3ddevice9_h
#define _anmd3ddevice9_h
...
class CAnmD3DDevice9 : public CAnmDevice
{
...
protected:
	...
	String					m_vertexShaderProfile;
	String					m_pixelShaderProfile;
...
public:
	...
	CAnmD3DDevice9(HWND hWnd, class cApplication *pApp);
	~CAnmD3DDevice9();
