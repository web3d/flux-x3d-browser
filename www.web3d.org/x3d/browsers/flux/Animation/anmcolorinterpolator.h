...
#ifndef _anmcolorinterpolator_h
#define _anmcolorinterpolator_h

#include "anmnode.h"
#include "anminterpolator.h"

class CAnmColorInterpolator : public CAnmNode
{
protected:

	CAnmInterpolator<Color>	m_interp;

public:

	// constructor/destructor
	CAnmColorInterpolator();
	virtual ~CAnmColorInterpolator();
	...
	virtual void SetKeyValue(ColorArray *pKeyValue);
	virtual ColorArray *GetKeyValue() { return m_interp.GetKeyValue(); }
	virtual void GetKeyValue(ColorArray **pKeyValue) { m_interp.GetKeyValue(pKeyValue); }

	// Linkage for callbacks, methods, values. include in all classes derived from this one
	DECLARE_NODECLASS(CAnmColorInterpolator);
