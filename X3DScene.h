 ...
 *
 * File: X3DScene.h
 * Description: Declaration of the CX3DScene
 *
...
// X3DScene.h : Declaration of the CX3DScene

#ifndef __X3DSCENE_H_
#define __X3DSCENE_H_
...
/////////////////////////////////////////////////////////////////////////////
// CX3DScene
class ATL_NO_VTABLE CX3DScene : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CX3DScene, &CLSID_CoX3DScene>,
	public IDispatchImpl<X3DScene, &IID_X3DScene, &LIBID_ANIMALib>,
	public X3DExecBase
{
public:
	CX3DScene()
...
DECLARE_REGISTRY_RESOURCEID(IDR_X3DSCENE)

DECLARE_PROTECT_FINAL_CONSTRUCT()

BEGIN_COM_MAP(CX3DScene)
	COM_INTERFACE_ENTRY(X3DScene)
...
public:
	...
	STDMETHOD(getMetaData)(/*[in]*/ BSTR key, /*[out,retval]*/ BSTR *value);
 	STDMETHOD(setMetaData)(/*[in]*/ BSTR key, /*[in]*/ BSTR value);
 	STDMETHOD(addRootNode)(/*[in]*/ X3DNode *node);
 	STDMETHOD(removeRootNode)(/*[in]*/ X3DNode *node);
};
